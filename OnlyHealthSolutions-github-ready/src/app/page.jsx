...
export default function HomePage() {
  ...
  return (
    <FixedBackgroundShell>
      ...
      {/* Full Width Features Grid - TEXT CLOSER TO VIDEO */}
      <div style={{ width: "100%", backgroundColor: "#ffffff", marginTop: "-40px", position: "relative", zIndex: 10, overflow: "hidden", padding: "40px 0" }}>
