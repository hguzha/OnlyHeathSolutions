...
export default function HomePage() {
  ...
  return (
    <FixedBackgroundShell>
      ...
      {/* Full Width Features Grid - MOBILE PADDING REMOVED */}
      <div style={{ width: "100%", backgroundColor: "#ffffff", marginTop: "-12px", position: "relative", zIndex: 10, overflow: "hidden", padding: isMobile ? "0px 0" : "40px 0" }}>
