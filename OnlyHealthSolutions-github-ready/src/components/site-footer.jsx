        ...
        <div className="footer-grid">
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", textAlign: "left" }}>
            <div style={{ width: "100%", display: "block" }}>
              <img src={brand.logo} alt={brand.name} style={{ height: 180, width: "100%", marginBottom: 16, display: "block", margin: 0, padding: 0, objectFit: "contain", textAlign: "left" }} />
              <p style={{ color: "rgba(255,255,255,0.8)", margin: 0, lineHeight: 1.6, padding: 0, width: "100%" }}>
