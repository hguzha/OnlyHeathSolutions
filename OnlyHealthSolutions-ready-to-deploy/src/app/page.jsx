    ...
    >
      ...
      <main>
        ...
        <Section
          ...
          subtitle="Join a team that values compassion, professionalism, and growth."
          ...
          <Card className="rounded-3xl border/60 bg-background/80 shadow-sm backdrop-blur">
            <CardContent className="p-6">
              <div className="text-sm text-muted-foreground">
                ...
                <a className="underline" href={brand.emailHref}>{brand.emailDisplay}</a>.
              </div>
            </CardContent>
          </Card>
        </Section>
        ...
        <Section
          ...
          subtitle="Call, email, or send a message. We’ll respond promptly."
          className="with-divider"
        >
          <div className="grid gap-4 md:grid-cols-12">
            ...
            <Card className="rounded-3xl md:col-span-7">
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Share the location, schedule, and care needs. We’ll reach out shortly.
                </p>
              </CardHeader>
              <CardContent>
        ...
        <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
          <div
            ...
            style={{ borderColor: `${brand.colors.primary}22` }}
          >
            <a
              href={brand.phoneHref}
              onClick={dialNow}
